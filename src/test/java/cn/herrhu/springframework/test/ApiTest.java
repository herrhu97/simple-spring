...
public class ApiTest {
    ...
    public void test_BeanFactory() {
        ...
        UserService userService = (UserService) beanFactory.getBean("userService", "herrhu");
...
//        userService.queryUserInfo();
    ...
    public void test_constructor() throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        UserService userService = declaredConstructor.newInstance("herrhu");
        System.out.println(userService);
    }
    ...
    public void test_cglib() {
        ...
        Object obj = enhancer.create(new Class[]{String.class}, new Object[]{"herrhu"});
